...
public final class employer_list_manage extends javax.swing.JInternalFrame {

    static Statement stmt;
    public static employer_add frmNew;
    public static employer_edit frmEdit;
    Employer employer = new Employer();
    EmployerC employerc = new EmployerC();

    public employer_list_manage() {
        initComponents();
        setListModel();
    ...
    public void setListModel() {
        lst.setModel(new EmployerC().getEmployerListModel());
    }

    public void ShowFrmEdit() {
        frmEdit = new employer_edit(this, true);
        frmEdit.setVisible(true);
    }

    public void ShowFrmNew() {

        frmNew = new employer_add(this, true);
    ...
    boolean check_existance(int did) {
        ...
        String createString;
        createString = "SELECT employer_id FROM employee WHERE employer_id=" + did;
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Employers");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/images/employer.png"))); // NOI18N
        ...
        jLabel1.setText("List of Employer/s");
    ...
    private void cmdeditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdeditActionPerformed
        try {
            int id = ((Employer) lst.getSelectedValue()).getEmployerId();
            employer_edit.employerid = id;
            ShowFrmEdit();
        } catch (Exception e) {
        ...
        try {
            ...
            if (ifexist == true) {
                ...
                if (i == 0) {
                    ...
                    if (employerc.deleteEmployer(employer) > 0) {
                        setListModel();
                        //this.dispose();
                    } else {
