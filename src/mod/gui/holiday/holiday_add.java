...
public class holiday_add extends javax.swing.JDialog {
    ...
    public holiday_add(holiday_manage parent, boolean modal) {
    ...
    private void cmdaddnewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdaddnewActionPerformed
        ...
        if (desc.isEmpty() == true || "--SELECT--".equals(cmbmonth.getSelectedItem().toString())) {
            ...
            if (holidayc.addHoliday(holiday) > 0) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                holiday_add dialog = new holiday_add(frmParent, true);
