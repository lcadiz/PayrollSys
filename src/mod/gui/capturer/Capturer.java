...
import mod.gui.employee.employee_edit;
//import javax.swing.DefaultListModel;

public class Capturer extends javax.swing.JDialog {
    ...
    public Capturer(employee_edit parent, boolean modal) {
...
//        }
    ...
    private void initComponents() {
        ...
        cmdCapture.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/picture.png"))); // NOI18N
        ...
        jDesktopPane1.add(LBLCAPTION, javax.swing.JLayeredPane.DEFAULT_LAYER);

        capturer1.setForeground(new java.awt.Color(255, 102, 0));
        capturer1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/captures2.png"))); // NOI18N
        ...
        jDesktopPane1.add(capturer1, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/capturer.png"))); // NOI18N
        jLabel4.setBounds(30, 380, 80, 80);
        ...
        jDesktopPane1.add(preview, javax.swing.JLayeredPane.DEFAULT_LAYER);
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cmdCapture, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void cmdSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSaveActionPerformed
        try {
            ...
            writeImage(img, path + empid + ".jpg", "jpg");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "No capturing device detected!");
           // ex.getMessage();
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Capturer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Capturer dialog = new Capturer(frmParent, true);
