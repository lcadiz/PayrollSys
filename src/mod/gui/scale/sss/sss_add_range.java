...
public class sss_add_range extends javax.swing.JDialog {
    ...
    public sss_add_range(sss parent, boolean modal) {
    ...
    public static void add_range(String start, String end, String base, String ee, String er, String ec) {
        Connection conn = myDBConn.getConnection();
        String createString;
        createString = "INSERT INTO sss(range_start, range_end, salary_base, ee, er, ec) "
                + "VALUES ('" + start + "','" + end + "','" + base + "','" + ee + "','" + er + "'," + ec + ")";
    ...
    private void cmdaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdaddActionPerformed
        ...
        BigDecimal bec = BigDecimal.valueOf(Double.parseDouble(txtec.getText().replace(",", "")));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                sss_add_range dialog = new sss_add_range(frmParent, true);
