...
public class sss_edit_range extends javax.swing.JDialog {

    public static sss frmParent;
    static Statement stmt;
    public static String sssid;
    SSS sss = new SSS();
    SSSC sssc = new SSSC();

    public sss_edit_range(sss parent, boolean modal) {
    ...
    public void populateFields() {
        ...
        String createString;
        createString = "SELECT range_start, range_end, salary_base, ee, er, ec "
                + "FROM sss WHERE sss_id=" + sssid;
        try {
...
//    public static void edit_range(String start, String end, String base, String ee, String er, String ec, int id) {
//        Connection conn = myDBConn.getConnection();
//        String createString;
//        createString = "UPDATE sss SET range_start='" + start + "', range_end='" + end + "', salary_base='" + base + "', ee='" + ee + "', er='" + er + "', ec='" + ec + "' "
//                + "WHERE sss_id=" + id;
//
//        try {
//            stmt = conn.createStatement();
...
//    }
    ...
    private void initComponents() {
        ...
        txtec = new javax.swing.JFormattedTextField();
        ...
        txtec.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
        txtec.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,###.00"))));
        txtec.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtec, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void cmdaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdaddActionPerformed
        ...
        BigDecimal bend = BigDecimal.valueOf(Double.parseDouble(txtstart.getText().replace(",", "")));
        BigDecimal bbase = BigDecimal.valueOf(Double.parseDouble(txtstart.getText().replace(",", "")));
        BigDecimal bee = BigDecimal.valueOf(Double.parseDouble(txtstart.getText().replace(",", "")));
        BigDecimal ber = BigDecimal.valueOf(Double.parseDouble(txtstart.getText().replace(",", "")));
        BigDecimal bec = BigDecimal.valueOf(Double.parseDouble(txtstart.getText().replace(",", "")));
        ...
        String ec = txtec.getText().replace(",", "");

        if (start.isEmpty() == true || end.isEmpty() == true || base.isEmpty() == true || ee.isEmpty() == true || er.isEmpty() == true || ec.isEmpty() == true) {
            JOptionPane.showMessageDialog(null, "Please fill-up all the required fields!");
        } else {
            sss.setRangeStart(bstart);
            sss.setRangeEnd(bend);
            sss.setSalaryBase(bbase);
            sss.setEe(bee);
            sss.setEr(ber);
            sss.setEc(bec);
            sss.setSssId(Short.parseShort(sssid));

            if (sssc.editSSS(sss) > 0) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                sss_edit_range dialog = new sss_edit_range(frmParent, true);
    ...
    private javax.swing.JFormattedTextField txtec;
