...
public class dependent_edit extends javax.swing.JDialog {

    public static employee_add frmParent;
    static String nowDate = myFunction.getDate();
    public static int selrow;
    public dependent_edit(employee_add parent, boolean modal) {
    ...
    void setDatas() {
        ...
        try {
            theDate = sdf.parse(frmParent.getDBdate(selrow));
        } catch (ParseException e) {
        }
        //txtdate.setDateFormatString(nowDate);
        txtbdate.setDate(theDate);
        
        txtname.setText(frmParent.getDName(selrow));
        txtrelation.setText(frmParent.getDRelation(selrow));
    ...
    private void initComponents() {
        ...
        setTitle("Edit Current Dependent");
        setResizable(false);
    ...
    private void cmdsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdsaveActionPerformed
        ...
        if (name.isEmpty() == true || relation.isEmpty() == true || bdate.isEmpty() == true) {
            ...
            frmParent.setvalueatTBL(name, relation, bdate, selrow);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dependent_edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dependent_edit dialog = new dependent_edit(frmParent, true);
